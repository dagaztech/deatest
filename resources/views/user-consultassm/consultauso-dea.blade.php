...
@section('title', __('Consulta de Uso de los DEA'))
                      ...
                      <div class="btns-vertical-wrapper"> 
                        <div class="row">
                            ...
                            <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="orange-btn">
                                <a href="/form-values/13/view" alt="Consulta de Uso DEA">Consulta de Uso DEA</a>
                             </div>
                             <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="orange-btn">
                             ...
                             <div class="col-md-6 mx-auto btn-navigate btn-primary btn-block mt-3" id="orange-btn">
                                <a href="{{ route('user-consultassm.eventos-criticosactivos') }}" alt="Eventos Críticos Activos">Eventos Críticos Activos</a>
                             </div>
                        </div>
                      </div>
                    </div>
