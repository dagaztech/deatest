                ...
                <div class="col-xl-9">
                    ...
                    <div id="storage-setting" class="">
                        ...
                        <div class="card" id="settings-card">
                            ...
                            <div class="card-body">
                                <div class="pb-3">
                                    <p class="text-danger">{{ __('Note :- If you Add S3 & wasabi Storage settings then you have to store all images First.') }}</p>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="justify-content-between card-header d-flex align-items-center">
                            ...
                            <div class="d-flex align-items-center text-end">
                                <div class="custom-control custom-switch" onclick="enableseo()">
                                    ...
                                    <small class="text-end d-flex mt-2">{{ __('Please turn on this SEO Enable button.') }}</small>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
