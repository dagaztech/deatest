...
@section('breadcrumb')
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10">{{ __('Diligenciamiento de Formularios') }}</h4>
        </div>
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> {{ __('Diligenciamiento de Formularios') }} </li>
        </ul>
    </div>
@endsection
@section('content')
                    ...
                    if (response.is_success) {
                        ...
                        //if('{{ $form->id }}' == 13){
                            //$('.form-card-body').html(
                                        ...
                                        //'</hr>'+
                                        '<img src="{{ asset('assets/images/success.gif') }}" class="" /><br><br><h2 class="w-100 //">' +
