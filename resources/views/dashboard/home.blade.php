                                    ...
                                    <div class="card comp-card number-card">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-12">
                                                    <h6 class="m-b-20 text-muted">{{ __('Total ed Form') }}</h6>
                            ...
                            <div class="m-0 card comp-card">
                                <div class="card-body admin-wish-card">
                                    <div class="row h-100">
                                        ...
                                        <h4 class="f-w-400">
                                            <a href="{{ Storage::exists(Auth::guard('api')->user()->avatar) ? Storage::url(Auth::guard('api')->user()->avatar) : Auth::guard('api')->user()->avatar_image }}" target="_new">
                                                <img src="{{ Storage::exists(Auth::guard('api')->user()->avatar) ? Storage::url(Auth::guard('api')->user()->avatar) : Auth::guard('api')->user()->avatar_image }}"
                                                    class="me-2 img-thumbnail rounded-circle" width="50px"
                                                    height="50px"></a>
                                            <span class="text-muted">{{ Auth::guard('api')->user()->name }}</span>
                                        </h4>
                                        <p>
