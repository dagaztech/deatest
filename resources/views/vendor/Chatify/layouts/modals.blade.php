  ...
  <div class="app-modal" data-name="delete">
      <div class="app-modal-container">
          <div class="app-modal-card" data-name="delete" data-modal='0'>
              <div class="app-modal-header">{{ __('¿Está seguro de que quieres eliminar esto?') }}</div>
              <div class="app-modal-body">{{ __('No puedes deshacer esta acción.') }}</div>
      ...
      <div class="app-modal-container">
          <div class="app-modal-card" data-name="settings" data-modal='0'>
              <form id="updateAvatar" action="{{ route('avatar.update') }}" enctype="multipart/form-data" method="POST">
                  @csrf
                  <div class="app-modal-header">{{ __('Actualiza la configuración de tu perfil') }}</div>
                  ...
                  <div class="app-modal-footer">
                      <a href="javascript:void(0)" class="app-btn cancel">{{ __('Cancelar') }}</a>
                      <input type="submit" class="app-btn a-btn-success update" value="{{ __('Actualizar') }}" />
                  </div>
              </form>
          </div>
      </div>
