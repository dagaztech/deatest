...
//EXCLUSIVO PARA TESTING 
   ...
   Route::get('users/index', [UserController::class, 'index'])->name('user.index');
    ...
    Route::get('/download-chart-data/{form_id}', [FormValueController::class, 'downloadChartData'])
    ->name('download.chart.data');

Route::get('/download-global-charts', [FormValueController::class, 'downloadGlobalCharts'])
    ->name('download.global.charts');
