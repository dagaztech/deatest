...
//EXCLUSIVO PARA TESTING 
   ...
   Route::get('users/index', [UserController::class, 'index'])->name('user.index');
    ...
    Route::get('/user-administrador/{id}/graficasbi', [GraficasController::class, 'mostrarGraficas'])
    ->name('user-administrador.graficasbi');

Route::get('/api/graficasbi/datos', [GraficasController::class, 'obtenerDatosDesdeTabla'])
    ->name('api.graficasbi.datos');

    Route::get('form-values/{form_id}/data', [FormValueController::class, 'extraerDatosAutomaticos']);
