...
public function generateCharts(Request $request)
{
    ...
    $locations = Form::distinct()->pluck('location'); // Obtener lugares únicos

    return view('user-administrador.graficasbi', compact('charts', 'locations'));
}
    ...
    public function filterChartData(Request $request, $formId)
{
    ...
    $data = $this->fetchFilteredData($form, $startDate, $endDate, $location);
