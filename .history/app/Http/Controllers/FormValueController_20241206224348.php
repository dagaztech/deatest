...
public function downloadChartData($formId)
{
    ...
    return Excel::download(new ChartDataExport($data), "chart_$formId.xlsx");
}
public function downloadGlobalCharts()
{
    ...
    $sheets = $forms->map(function ($form) {
        ...
        return new ChartDataExport($data, "Formulario $form->id");
    });

    return Excel::download(new MultiSheetExport($sheets), "todos_los_graficos.xlsx");
}
