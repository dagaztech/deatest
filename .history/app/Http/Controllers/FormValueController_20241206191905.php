...
class FormValueController extends Controller
{
    ...
    private function procesarHTMLTabla($html)
    {
        try {
            ...
            // Buscar la tabla dentro del contenedor especificado
            $tabla = $xpath->query('//div[contains(@class, "table-responsive") and contains(@class, "py-4") and contains(@class, "submitformtable")]//table');
