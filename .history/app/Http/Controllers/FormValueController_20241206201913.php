...
public function graphSubmitedForms($form_id, FormValuesDataTable $dataTable)
{
    ...
    // Asegurarse de que $chartData tiene las claves 'labels' y 'data'
    $labels = $chartData['labels']; // Las etiquetas del gráfico
    ...
    return $dataTable->with('form_id', $form_id)->render('user-administrador.graficasbi', compact('forms', 'chartData', 'formsDetails', 'labels', 'data'));
}
