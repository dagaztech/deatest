...
*/
    ...
    public function eventos_criticosactivos()
    {
        ...
        $datos = DB::where('form_id', 12)->orderBy('created_at', 'desc')->get(['id', 'Coordenada: Longitud', 'Coordenada: Latitud', 'created_at']);
    ...
    public function informe_ubicaciondeas()
    {
        ...
        $datos = DB::where('form_id', 33)->orderBy('created_at', 'desc')->get(['id', 'Coordenada: Longitud', 'Coordenada: Latitud', 'created_at']);
