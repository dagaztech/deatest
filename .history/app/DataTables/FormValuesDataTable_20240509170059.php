            ...
            ->addColumn('user', function (FormValue $formValue) {
                ...
                ->editColumn('user', function (FormValue $formValue) {
                    ...
                    $nombre = array_filter($arr[0], function($campo) {
                      ...
                      if($campo['label'] == "Nombre completo" || $campo['label'] == "Nombre" || $campo['label'] == "Nombre de la persona que utilizó el DEA" || $campo['label'] == "Nombre Completo" || $campo['label'] == "Nombre del lugar" || $campo['label']  == "Título del Acta" || $campo['label']  == "DEA Visitado"){
