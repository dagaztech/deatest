...
<script>
  ...
  <script>
    // Seleccionamos el elemento select y los divs correspondientes
    const selectElement = document.querySelector('select[name="select-1703769572024-0"]');
    const nameFieldDiv = document.querySelector('[data-name="namefield"]');
    const textFieldDiv = document.querySelector('[data-name="text-1703769659485-0"]');
