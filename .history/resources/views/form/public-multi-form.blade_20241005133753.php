...
<script>
    ...
    function validateForm() {
        ...
        $('textarea[required], number[required], password[required]').each(function(){
            if ($(this).val() === '') {
                allFilled = false;
                return false; 
            }
    ...
    $('input[required], select[required], textarea[required], number[required], date[required], password[required]').on('keyup', function() {
        validateForm();
    });

    $('#cedulacode, #cedulacodedea, #cedulacodepaciente').on('keyup', function() {
        validateForm();
    });

    $('#dea-usuario-contrasena').on('keyup', function() {
        validateForm();
    });
});
    </script>
