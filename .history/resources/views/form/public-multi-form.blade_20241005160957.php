...
<script>
    ...
    function validateForm() {
        ...
        $('input[required], select[required], textarea[required], number[required], password[required]').each(function(){
            if ($(this).val() === '') {
                allFilled = false;
                return false; 
            }
    ...
    $('input[required], select[required], textarea[required], number[required], date[required], password[required]').on('keydown', function() {
        validateForm();
    });
    $('#cedulacode, #cedulacodedea, #cedulacodepaciente').on('keydown', function() {
        validateForm();
    });
    $('#dea-usuario-contrasena').on('keydown', function() {
        validateForm();
    });
