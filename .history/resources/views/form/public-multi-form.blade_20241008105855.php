...
<script>
  ...
  if (window.location.href == 'https://dea.wearesmart.co/forms/survey/PLG6vkQBeXrkbyK82gAj') {
    $(document).ready(function() {
        ...
        $('[data-name="namefield"]').eq(2).hide(); // Ocultamos el tercero (índice 2)
        ...
        $('select[name="select-1703769572024-0"]').change(function() {
            ...
            $('[data-name="namefield"]').eq(2).hide(); // Ocultamos el tercero nuevamente
            $('[data-name="text-1703769659485-0"]').hide();
            ...
            if (selectedValue === 'otro') {
                ...
                $('[data-name="namefield"]').eq(2).show(); // Mostrar solo el tercer 'namefield'
            }
        });
    });
}
