...
<script>
    ...
    $('input[required], select[required], textarea[required], number[required], date[required], password[required], #cedulacode, #cedulacodedea, #cedulacodepaciente, #dea-usuario-contrasena').on('keyup', function() {
        validateForm();
    });
});
    </script>
