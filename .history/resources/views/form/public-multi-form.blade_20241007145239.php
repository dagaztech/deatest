...
<script>
    ...
    function validateForm() {
        ...
        $('input[required], select[required], textarea[required], number[required], file[required], date[required], datefield[required], password[required]').each(function(){
            if ($(this).val() === '') {
                allFilled = false;
                return false; 
            }
    ...
    $('input[required], select[required], textarea[required], number[required], file[required], date[required], datefield[required], password[required], #cedulacode, #cedulacodedea, #cedulacodepaciente, #dea-usuario-contrasena').on('keydown', function() {
        validateForm();
    });
