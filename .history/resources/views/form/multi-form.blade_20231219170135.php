...
@if ($data !== null || $type == 'Admin' || $type == 'public')
    <div class="section-body blue-background">
        ...
        <div class="mobile-menu-wrapper">
            <div class="mobile-menu-bar">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-4">
                            <a href="#" alt="Volver"><img src="{{ asset('assets/images/FlechaIzq.png') }}" alt="Volver" /></a>
                        </div>
                        <div class="col-md-4">
                            <img src="{{ asset('assets/images/logo.png') }}" alt="Logo Alcaldía de Medellín" />
                        </div>
                        <div class="col-md-4">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mobile-login-btn">
                                        <a href="{{ route('previous') }}" class="top-menu-items" id="home-btn"> {{ __('Previous') }}</a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mobile-login-btn">
                                        <a href="{{ route('logout') }}" class="top-menu-items" id="logout-btn"> {{ __('Logout') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
