...
<script>
    ...
    document.getElementById('miFormulario').setAttribute('autocomplete', 'off');

    // Aplica el autocomplete off y previene datos preexistentes campo por campo
    document.querySelectorAll('#miFormulario input, #miFormulario textarea, #miFormulario select').forEach(function (campo) {
