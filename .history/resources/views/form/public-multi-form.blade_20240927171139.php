...
<script>
 ...
 <script>
    // Oculta ambos divs al cargar la página
    document.addEventListener('DOMContentLoaded', function() {
      document.querySelector('[data-name="namefield"]').style.display = 'none';
      document.querySelector('[data-name="text-1703769659485-0"]').style.display = 'none';
    });

    document.getElementById('sschoices-multiple-remove-button').addEventListener('change', function() {
      const selectedValue = this.value;

      // Oculta ambos divs antes de mostrar el correcto
      document.querySelector('[data-name="namefield"]').style.display = 'none';
      document.querySelector('[data-name="text-1703769659485-0"]').style.display = 'none';

      // Muestra el div correspondiente según la opción seleccionada
      if (selectedValue === 'otro') {
        document.querySelector('[data-name="namefield"]').style.display = 'block';
      } else if (selectedValue === 'ambulancia') {
        document.querySelector('[data-name="text-1703769659485-0"]').style.display = 'block';
      }
    });
  </script>
...
#cedulacodepaciente-error, label.error{
 ...
 [data-name="namefield"],
    [data-name="text-1703769659485-0"] {
      display: none;
      */
      </style>
