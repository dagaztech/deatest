                                                ...
                                                @elseif($row->type == 'text')
                                                    ...
                                                    <div class="form-group {{ $class }} {{ $col }}"
                                                        ...
                                                        @php
                                                            ...
                                                            /*$attr['onkeydown'] = 'this.value = this.value.replace(/[0-9]/g,"")';*/
                                                            if ($row->required) {
                                                                $attr['required'] = 'required';
...
<script>
 document.querySelector('input[name="postalcode"]').onkeydown = function () {
...
<script>
    document.querySelector('input[name="edadcode"]').onkeydown = function () {
...
<script>
    document.querySelector('input[name="pacientetelefono"]').onkeydown = function () {
...
<script>
document.querySelector('input[name="telefono-operador"]').onkeydown = function () {
...
<script>
    document.querySelector('input[name="dea-usuario-contrasena"]').onkeydown = function () {
       if (this.value.length >= 12 ) {
           this.value = this.value.slice(0,12); 
       }else{
...
<script>
document.querySelector('textarea[class="text-area-height"]').onkeyup = function () {
    if (this.value.length > 1200) {
        this.value = this.value.slice(0, 1200); // Limita el contenido a 1200 caracteres
    }
    
    if (this.value.length >= 1200) {
        alert("Ingrese máximo 1200 caracteres"); // Muestra la alerta si se excede el límite
    }
};
</script>
<script>
...
<script>
    ...
    function validateForm() {
        ...
        $('input[required], select[required], textarea[required], number[required], file[required], date[required], password[required]').each(function(){
            if ($(this).val() === '') {
                allFilled = false;
                return false; 
            }
    ...
    $('input[required], select[required], textarea[required], number[required], file[required], date[required], password[required], #cedulacode, #cedulacodedea, #cedulacodepaciente, #dea-usuario-contrasena').on('keydown', function() {
        validateForm();
    });
