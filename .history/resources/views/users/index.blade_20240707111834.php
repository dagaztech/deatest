...
@section('breadcrumb')
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10">{{ __('Usuarios') }}</h4>
        </div>
        <ul class="breadcrumb">
        ...
        <div class="float-end">
            <div class="d-flex align-items-center">
                <a href="{{ route('grid.view','view') }}" data-bs-toggle="tooltip" title="{{ __('Vista Grid') }}"
...
@push('script')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Establecer la opción seleccionada en "+57 Colombia"
            countryCodeSelect.value = "+57 Colombia";
        
            // Alternativamente, puedes buscar y seleccionar la opción manualmente
            
            for (let i = 0; i < countryCodeSelect.options.length; i++) {
                if (countryCodeSelect.options[i].value === "+57") {
