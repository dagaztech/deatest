                      ...
                      <div class="btns-vertical-wrapper"> 
                        <div class="row">
                            <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="green-btn">
                                <a href="{{ route('user-consultassm.consssm-agendamiento') }}" alt="Agendamiento">Agendamiento</a>
                             </div>
                             <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="green-btn">
                                <a href="{{ route('user-consultassm.consssm-planeacion') }}" alt="Planeación">Planeación</a>
                             </div>
                             <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="green-btn">
                                <a href="{{ route('user-consultassm.consssm-seguimiento') }}" alt="Seguimiento">Seguimiento</a>
                             </div>
                             <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="green-btn">
                                <a href="{{ route('user-administrador.reportes-useradmin') }}" alt="Reportes">Reportes</a>
                             </div>
                        </div>
                      </div>
                    </div>
