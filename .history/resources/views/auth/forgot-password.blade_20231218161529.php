         ...
         <div class="login-row d-flex">
                <div class="login-content-inner">
                    ...
                    <div class="text-center d-flex justify-content-center align-items-center">
                        {{ Form::button(__('Enviar enlace para restablecer contraseña'), ['type' => 'submit', 'class' => 'btn btn-primary']) }}
                        <a href="{{ route('home') }}" class="ml-2 text-white btn btn-secondary">{{ __('Regresar') }}</a>
                    </div>
