      ...
      <div class="dronwalcaldia_">
         <div class="titulalcaldia_">
            ...
            <div class="drop">
               ...
               <p class="iconChevron"  data-toggle="dropdown" onclick="myDisplayFunction()" ondblclick="myHideFunction()">
         ...
         <div class="login-row d-flex">
                    <div class="login-content-inner">
                        ...
                        <div class="mb-3 form-group">
                            {{ Form::label('email', __('Correo electrónico'), ['class' => 'form-label mb-2']) }}
                        ...
                        <div class="mb-3 form-group">
                            {{ Form::label('password', __('Nueva contraseña'), ['class' => 'form-label']) }}
                            {!! Form::password('password', [
                                'class' => 'form-control',
                                'placeholder' => __('Ingresar nueva contraseña'),
                                'required',
                                'id' => 'password',
                        ...
                        <div class="mb-3 form-group">
                            {{ Form::label('password_confirmation', __('Confirmar nueva contraseña'), ['class' => 'form-label']) }}
                        ...
                        <div class="d-grid">
                            {!! Form::button(__('Cambiar la contraseña'), ['type' => 'submit', 'class' => 'btn btn-primary btn-block mt-2']) !!}
                        </div>
                        {{ Form::close() }}
                    </div>
                </div>
