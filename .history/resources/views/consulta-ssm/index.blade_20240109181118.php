        ...
        <div class="mx-auto col-md-12 rounded-card">
                <div class="card">
                    <div class="card-header">
                        <h5 class="text-center w-100" id="new-title">Consultas SSM</h5>
                    </div>
                    <div class="card-body form-card-body">
                      <div class="btns-vertical-wrapper"> 
                        <div class="row">
                            <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="purple-btn">
                               <a href="{{ route('consulta-ssm.regequipos-dea') }}" alt="Consulta de Registro de Equipos DEA">Consulta de Registro de Equipos DEA</a>
                            </div>
                            <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="orange-btn">
                                <a href="{{ route('consulta-ssm.consultauso-dea') }}" alt="Consulta de Uso de los DEA">Consulta de Uso de los DEA</a>
                             </div>
                             <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="green-btn">
                                <a href="{{ route('consulta-ssm.agendamiento-planesrepo') }}" alt="Agendamiento, Planeación y Reportes">Agendamiento, Planeación y Reportes</a>
                             </div>
                             <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="purple-btn">
                                <a href="{{ route('user-administrador.reportes-useradmin') }}" alt="Visualización de datos">Visualización de datos </a>
                             </div>
                        </div>
                      </div>
                    </div>
