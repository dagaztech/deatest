          ...
          <div class="card-body form-card-body">
            ...
            <form id="filtro-form">
                ...
                <select id="selectorTipoFecha" class="form-select w-33">
                    <option value="dia">Por Dí­a</option>
                    <option value="rango">Por Rango</option>
                  </select>
                    <input type="text" class="form-control mr-1  w-33" id="single" name="single" placeholder="Fecha específica" style="display:block;">
                    <input type="text" class="form-control mr-1  w-33" id="rango" name="rango" placeholder="Rango de fechas" style="display:none;">
