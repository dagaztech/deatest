                      ...
                      <form id="filterForm">
                        <div class="row">
                          <div class="form-group col-sm-4">
                            <input class="form-control" placeholder="Selecciona rango de fechas" id="rangoFechas" name="rango" type="date" readonly="readonly">
                          </div>
                          <div class="form-group col-sm-4">
                            <input class="form-control" placeholder="Selecciona día específico" id="diaEspecifico" name="dia" type="date" readonly="readonly">
                          </div>
                          <div class="col-sm-4">
