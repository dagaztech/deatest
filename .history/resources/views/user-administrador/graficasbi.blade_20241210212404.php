                    ...
                    <div class="row">
                        <div class="graphicblock">
                            ...
                            <div class="p-3 mt-12">
                                ...
                                <input type="text" id="search-{{ $chart['form_id'] }}" class="filter-input w-50" data-form-id="{{ $chart['form_id'] }}" placeholder="Escriba para filtrar: mes, número o fecha tipo DDMMAA">
