    ...
    charts.forEach(chart => {
        ...
        function filterData() {
            ...
            originalLabels.forEach((label, index) => {
                const monthIndex = originalLabels.indexOf(label); // Índice del mes (0 para Enero, 11 para Diciembre)
                const recordDate = new Date(2023, monthIndex); // Simula un año fijo para comparar meses
                if ((!isNaN(startDate) && !isNaN(endDate) && recordDate >= startDate && recordDate <= endDate) ||
