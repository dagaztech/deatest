                ...
                <div class="card"  id="purple-btn">
                    ...
                    <div class="card-body form-card-body">
                      ...
                      <form method="post" action="{{ url('user-administrador/tableros-useradmin') }}">
                        ...
                        <div class="form-group d-flex justify-content-start col-sm-4">
                            <input class="mr-1 form-control created_at flatpickr-input" placeholder="Selecciona rango de fechas" id="pc-daterangepicker-1" onchange="updateEndDate()" name="rango" type="text" readonly="readonly">
                        </div>
