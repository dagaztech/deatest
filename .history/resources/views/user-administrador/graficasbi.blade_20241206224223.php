                        ...
                        <div class="graphicblock">
                            @foreach($charts as $chart)
                                <div class="graphicblocker">
                                    <h6>Formulario ID: {{ $chart['form_id'] }}</h6>
                                    ...
                                    <div class="chart-controls">
                                        ...
                                        <button class="btn btn-sm btn-primary download-chart-data" data-form-id="{{ $chart['form_id'] }}">Descargar Excel</button>
                                    </div>
                                </div>
                            @endforeach
                        </div>
...
@push('script')
<style>
    .graphicblock { display: block; flex-wrap: wrap; gap: 0.5%; }
    .graphicblock h6 {
        text-align: center;
        background: #eee;
        padding: 10px;
