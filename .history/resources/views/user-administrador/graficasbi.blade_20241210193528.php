                    ...
                    <div class="row">
                        <div class="graphicblock">
                            ...
                            <div class="p-3 mt-12">
                                ...
                                <label for="fecha-range">Filtrar por Fecha (rango):</label>
                                <input type="text" id="fecha-range" class="filter-daterange" data-form-id="{{ $chart['form_id'] }}">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    charts.forEach(chart => {
        ...
        $('#fecha-range').on('apply.daterangepicker', function (ev, picker) {
    ...
    // Función para filtrar tabla y gráfico según el rango de fechas
    function filterDataByDateRange(formId, startDate, endDate) {
        ...
        filas.forEach(fila => {
            const dateCell = fila.children[0].textContent; // Asumiendo que la fecha está en la primera columna
            const date = moment(dateCell, 'YYYY-MM-DD');

            // Verificar si la fecha está dentro del rango
            if (date.isBetween(startDate, endDate, null, '[]')) {
                fila.style.display = ''; // Mostrar la fila
                filteredData.push(parseInt(fila.children[1].textContent)); // Asumiendo que los datos están en la segunda columna
