        ...
        <div class="mx-auto col-md-12 rounded-card">
            <div class="card" id="purple-btn">
                ...
                <div class="card-body form-card-body">
                        ...
                        <div class="graphicblock">
                            @foreach($charts as $chart)
                                <div class="graphicblocker">
                                    <h6>Formulario ID: {{ $chart['form_id'] }}                                   &nbsp; | &nbsp;<a href="{{ route('download.chart.data', ['form_id' => $chart['form_id']]) }}" 
                    ...
                    <button id="download-global" 
                    class="btn btn-success" 
                    onclick="window.location.href='{{ route('download.global.charts') }}'">
                Descarga Global
            </button>
                </div>
            </div>
...
<script>
    ...
    charts.forEach(chart => {
        console.log('Inicializando gráfico para el formulario ID:', chart.form_id);  // Verificar el ID de cada gráfico
