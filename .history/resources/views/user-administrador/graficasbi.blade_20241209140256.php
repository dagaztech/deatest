                    ...
                    <div class="row">
                        <div class="graphicblock">
                            ...
                            <div class="chart-controls">
                                <!-- Filtros existentes -->
                                <label for="dia-exacto-{{ $chart['form_id'] }}">Filtrar por Día Exacto:</label>
                                <input type="date" id="dia-exacto-{{ $chart['form_id'] }}" class="filter-date-exacto" data-table="table-{{ $chart['form_id'] }}" data-chart="chart-{{ $chart['form_id'] }}">
                            
                                <label for="mes-{{ $chart['form_id'] }}">Filtrar por Mes:</label>
                                <select id="mes-{{ $chart['form_id'] }}" class="filter-date-mes" data-table="table-{{ $chart['form_id'] }}" data-chart="chart-{{ $chart['form_id'] }}">
                                    <option value="">-- Todos los meses --</option>
                                    @foreach($chart['labels'] as $mes)
                                        <option value="{{ $mes }}">{{ ucfirst($mes) }}</option>
                                    @endforeach
                                </select>
                            
                                <label for="rango-inicio-{{ $chart['form_id'] }}">Filtrar por Rango de Fechas:</label>
                                <input type="date" id="rango-inicio-{{ $chart['form_id'] }}" class="filter-date-rango-inicio" data-table="table-{{ $chart['form_id'] }}" data-chart="chart-{{ $chart['form_id'] }}">
                                <input type="date" id="rango-fin-{{ $chart['form_id'] }}" class="filter-date-rango-fin" data-table="table-{{ $chart['form_id'] }}" data-chart="chart-{{ $chart['form_id'] }}">
                            
                                <!-- Botón de Reset -->
                                <button class="btn btn-secondary reset-filters" data-table="table-{{ $chart['form_id'] }}" data-chart="chart-{{ $chart['form_id'] }}">Resetear Filtros</button>
                            </div>
