          ...
          <div class="card-body form-card-body">
            ...
            <form id="filtro-form">
                ...
                <select id="selectorTipoFecha" class="form-select w-33">
                    ...
                    <input type="text" class="form-control mr-1 flatpickr-input  w-33" id="single" name="single" placeholder="Fecha específica">
                       <input type="text" class="form-control mr-1 flatpickr-input  w-33" id="rango" name="rango" placeholder="Rango de fechas">
