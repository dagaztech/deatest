                      ...
                      <form id="filterForm">
                        <div class="row">
                          <div class="form-group col-sm-4">
                            <input class="form-control created_at flatpickr-input" placeholder="Selecciona rango de fechas" id="rangoFechas"  name="rango" type="text" readonly="readonly">

                          </div>
                          <div class="form-group col-sm-4">
                            <input class="form-control created_at flatpickr-input" placeholder="Selecciona día específico" id="diaEspecifico"  name="dia" type="text" readonly="readonly">
