                          ...
                          <div class="row">
                              <div class="form-group d-flex justify-content-start col-sm-12">
                                  <div class="filterwrap">
                                      ...
                                      <input id="inputFechaUnica" class="form-control mr-1 flatpickr-input  w-33" type="text" placeholder="Seleccionar día" style="display:block;">
                                      <input id="inputRangoFechas" class="form-control mr-1 flatpickr-input  w-33" type="text" placeholder="Seleccionar rango" style="display:none;">
                                      <button type="button"  class="btn btn-primary w-33" id="mostrarResultados">Mostrar información</button>
                                  </div>
                              </div>
                          </div>
                      </form>
...
<script>
  $(document).ready(function() {
      ...
      // Generar los gráficos inmediatamente al cargar la página
      generarGraficos();
