                      ...
                      <form id="filterForm">
                        <div class="row">
                          <div class="form-group col-sm-4">
                            <input class="form-control" placeholder="Selecciona rango de fechas" id="rangoFechas" name="rango" type="text" readonly="readonly">
                          </div>
                          <div class="form-group col-sm-4">
                            <input class="form-control" placeholder="Selecciona día específico" id="diaEspecifico" name="dia" type="text" readonly="readonly">
                          </div>
                          <div class="col-sm-4">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function renderCharts(data) {
            ...
            const usoOptions = {
                ...
                xaxis: { categories: ['Enero', 'Febrero', ..., 'Diciembre'] },
