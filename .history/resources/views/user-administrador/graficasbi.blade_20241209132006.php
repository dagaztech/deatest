...
document.addEventListener('DOMContentLoaded', function () {
    ...
    charts.forEach(chart => {
        ...
        document.getElementById('reset-filters').addEventListener('click', function () {
            // Restablecer los valores de los filtros a sus valores iniciales
            document.querySelector(`#fecha-dia-${chart.form_id}`).value = '';
            document.querySelector(`#fecha-mes-${chart.form_id}`).value = '';
            document.querySelector(`#fecha-inicio-${chart.form_id}`).value = '';
            document.querySelector(`#fecha-fin-${chart.form_id}`).value = '';
            ...
            // Mostrar todos los datos en el gráfico
