                ...
                <div class="card"  id="purple-btn">
                    ...
                    <div class="card-body form-card-body">
                      ...
                      <form method="post" action="{{ url('user-administrador/tableros-useradmin') }}">
                        ...
                        <div class="form-group d-flex justify-content-start col-sm-4">
                            <input class="mr-2 form-control created_at flatpickr-input" placeholder="Selecciona por fecha" id="pc-daterangepicker-1" onchange="updateEndDate()" name="rango" type="text" readonly="readonly">
                            <input class="mr-2 form-control created_at flatpickr-input" placeholder="Selecciona por rango" id="pc-daterangepicker-2" onchange="updateEndDate()" name="single" type="text" readonly="readonly">
