  ...
  <script>
    $(document).ready(function() {
        ...
        function agruparPorDia(lista, mes) {
            return Array.from({ length: 31 }, (_, i) => lista.filter(x => x.mes == mes && x.dia == ("0" + (i + 1)).slice(-2)).length);
        }
        ...
        function generarGraficos(filtro = null) {
            ...
            var seriesEdad = Object.values(data3.reduce((acc, cur) => (acc[cur] = (acc[cur] || 0) + 1, acc), {}));
            ...
            var opcionesEdad = {
                ...
                labels: Object.keys(data3.reduce((acc, cur) => (acc[cur] = (acc[cur] || 0) + 1, acc), {})),
