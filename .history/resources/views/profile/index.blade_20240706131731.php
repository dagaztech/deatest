...
@section('breadcrumb')
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10">{{ __('Perfil de Usuario') }}</h4>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item">{!! Html::link(route('home'), __('Panel de Control'), []) !!}</li>
            <li class="breadcrumb-item"> {{ __('Perfil de Usuario') }} </li>
        </ul>
    </div>
@endsection
@section('content')
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-block d-sm-flex align-items-center justify-content-between w-100">
                                    <div class="mb-3 mb-sm-0">
                                        ...
                                        @if (\Auth::guard('api')->user()->social_type != null)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Crea un nuevo elemento option para Colombia
    const colombiaOption = document.createElement('option');
    colombiaOption.value = 'colombia';
    colombiaOption.textContent = 'Colombia';

    // Inserta el nuevo option al inicio del select
    selectElement.insertBefore(colombiaOption, selectElement.firstChild);
});
</script>
@endpush
