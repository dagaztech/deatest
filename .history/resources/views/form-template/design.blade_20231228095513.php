...
@section('title', __('Plantillas de Formulario'))
@section('breadcrumb')
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10">{{ __('Plantillas de Formulario') }}</h4>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item">{!! Html::link(route('home'), __('Panel de Control'), ['']) !!}</li>
            <li class="breadcrumb-item">{!! Html::link(route('form-template.index'), __('Plantillas de Formulario'), ['']) !!}</li>
            <li class="breadcrumb-item">{{ __('Diseno Plantilla Formulario') }}</li>
        </ul>
    </div>
@endsection
@section('content')
