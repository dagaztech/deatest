                      ...
                      <div class="btns-vertical-wrapper">
                        <div class="row">
                            <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="purple-btn">
                               <a href="#" alt="Anexo 2. Reporte de instalación del Desfibrilador Externo Automático (DEA). Formulario Dinámico.">Anexo 2. Reporte de instalación del Desfibrilador Externo Automático (DEA). Formulario Dinámico. </a>
                            </div>
                            <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="orange-btn">
                                <a href="#" alt="Anexo 3. Reporte del uso del Desfibrilador Externo Automático (DEA). Formulario Dinámico.">Anexo 3. Reporte del uso del Desfibrilador Externo Automático (DEA). Formulario Dinámico.</a>
                             </div>
                        </div>
                      </div>
                    </div>
