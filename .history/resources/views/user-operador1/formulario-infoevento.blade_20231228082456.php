...
@section('title', __('Información del Evento Cardiovascular'))
        ...
        <div class="mx-auto col-md-12 rounded-card" >
                <div class="card" id="green-btn">
                    <div class="card-header">
                        <h5 class="text-center w-100" id="new-title">Información del Evento Cardiovascular</h5>
                    </div>
...
<button type="button" class="btn btn-primary open-info" data-toggle="modal" data-target="#exampleModalCenter">
 <img src="../../images/info.png" alt="Abrir modal">
                        ...
                        <div class="row">
                          <iframe src="http://3.14.220.114:8000/forms/survey/PLG6vkQBeXrkbyK82gAj" scrolling="auto" style="height:100vh;" width="100%"></iframe>
                        </div>
