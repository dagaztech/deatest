...
@section('title', __('Editar Notificación por Email'))
@section('breadcrumb')
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10">{{ __('Editar Notificación por Email') }}</h4>
        </div>
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ __('Editar Notificación por Email') }}</li>
        </ul>
    </div>
@endsection
@section('content')
        ...
        <div id="basic" class="mx-auto col-lg-6 layout-spacing">
            <div class="statbox card box box-shadow">
                <div class="card-header">
                    <h5>{{ __('Editar Notificación por Email') }}</h5>
                </div>
