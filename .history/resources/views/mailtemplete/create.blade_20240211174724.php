...
@section('title', __('Crear Plantilla de Email'))
@section('breadcrumb')
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h4 class="m-b-10">{{ __('Crear Plantilla de Email') }}</h4>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item">{!! Html::link(route('home'), __('Panel de Control'), []) !!}</li>
                        <li class="breadcrumb-item">{!! Html::link(route('mailtemplate.index'), __('Plantillas de Email'), []) !!}</li>
                        <li class="breadcrumb-item active">{{ __('Crear Plantilla de Email') }}</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div id="basic" class="mx-auto col-lg-12 layout-spacing">
            <div class="statbox card box box-shadow">
                <div class="card-header">
                    <h5>{{ __('Crear Plantilla de Email') }}</h5>
                </div>
