...
class UsersDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return datatables()
            ...
            ->addColumn('role', function (User $user) {
                $out = '';
                $out = '<span class="p-2 px-3 badge rounded-pill bg-primary">' . $user->rol . '</span>';
                return $out;
            })
    ...
    {
        return $model->newQuery()->where('rol', '!=', 'Administrador')->orderBy('id', 'ASC');
    }
    ...
    $canCreateUser = \Auth::guard('api')->user()->rol == "Administrador";
    $canExportUser = \Auth::guard('api')->user()->rol == "Administrador";
    $buttonsConfig = [];
