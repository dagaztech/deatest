...
<?php $__env->startSection('breadcrumb'); ?>
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10"><?php echo e(__('Diligenciamiento de Formularios')); ?></h4>
        </div>
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> <?php echo e(__('Diligenciamiento de Formularios')); ?> </li>
        </ul>
    </div>
    ...
    <script>
        ...
        function nextPrev(n) {
            ...
            if (currentTab >= x.length) {
                ...
                var $this = $("#nextBtn");
                var loadingText = '<i class="ti ti-circle-dashed"></i> Registrando datos en sistema';
        ...
        function validateForm() {
            ...
            $('.step-' + currentTab).find('.required').each(function() {
                ...
                if ($(this).attr('type') == 'number') {
                    ...
                    if ($(this).val() == "") {
                        $(this).addClass('is-invalid');
                        $(this).next().html('Por favor diligencie este campo.');
                ...
                if ($(this).attr('type') == 'file') {
                    ...
                    if (inp.length == 0) {
                        $(this).addClass('is-invalid');
                        $(this).next().html('Por favor seleccione archivo para este campo.');
                        check.push(false);
                    } else {
                        $(this).removeClass('is-invalid');
                        $(this).addClass('is-valid');
                ...
                if ($(this).attr('type') == 'date') {
                    ...
                    if (inp.length == 0) {
                        $(this).addClass('is-invalid');
                        $(this).next().html('Por favor seleccione fecha para este campo.');
                        check.push(false);
                    } else {
                        $(this).removeClass('is-invalid');
                        $(this).addClass('is-valid');
                    ...
                    if (response.is_success) {
                        ...
                        //if('<?php echo e($form->id); ?>' == 13){
                            //$('.form-card-body').html(
                                        ...
                                        '<h3>Tu numero de confirmación es: <strong>'+ $("#number-1703769261276-0").val() +'//</strong></h3>' +
                                        //'</hr>'+
                                        '<img src="<?php echo e(asset('assets/images/success.gif')); ?>" class="" /><br><br><h2 class="w-100 //">' +
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/dea-template-pwa/resources/views/form/fill.blade.php ENDPATH**/ ?>