<?php $__env->startSection('title', __('Personal Certificado en el Uso del DEA')); ?>
...
<div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="purple-btn">
  <a href="<?php echo e(route('user-operador1.formulario-anexo25')); ?>" alt="Agregar nuevo personal">Agregar nuevo personal</a>
</div>
                        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/dea-template-pwa/resources/views/user-operador1/formulario-anexo25.blade.php ENDPATH**/ ?>