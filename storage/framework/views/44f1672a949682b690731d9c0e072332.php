<?php $__env->startSection('title', __('Editar Formulario')); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <div class="col-md-12">
        <div class="d-flex justify-content-between">
            <div class="previous-next-btn">
                <div class="page-header-title">
                    <h4 class="m-b-10"><?php echo e(__('Editar Formulario')); ?></h4>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>"><?php echo e(__('Panel de Control')); ?></a></li>
                    <li class="breadcrumb-item"><a href="<?php echo e(route('forms.index')); ?>"><?php echo e(__('Formularios')); ?></a></li>
                    <li class="breadcrumb-item"> <?php echo e(__('Editar Formulario')); ?> </li>
                </ul>
            </div>
            <div class="float-end">
                <div class="d-flex align-items-center">
                    <a href="<?php if(!empty($previous)): ?> <?php echo e(route('forms.edit', [$previous->id])); ?><?php else: ?> javascript:void(0) <?php endif; ?>"
                        type="button" class="btn btn-outline-primary"><i class="me-2"
                            data-feather="chevrons-left"></i><?php echo e(__('Anterior')); ?></a>
                    <a href="<?php if(!empty($next)): ?> <?php echo e(route('forms.edit', [$next->id])); ?><?php else: ?> javascript:void(0) <?php endif; ?>"
                        class="btn btn-outline-primary ms-1"><i class="me-2"
                            data-feather="chevrons-right"></i><?php echo e(__('Siguiente')); ?></a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <?php if($form->logo): ?>
                                    ...
                                    <?php else: ?>
                                    <div class="text-center form-group w-25">
                                        <?php echo Form::image(Storage::url($form->logo),
                                            null,
                                            [
                                                'class' => 'img img-responsive justify-content-center text-center form-img',
                                                'id' => 'app-dark-logo',
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <p><small><?php echo e(('Note')); ?> :- <?php echo e(__('This Description Only Show in front side')); ?></small></p>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/dea-template-pwa/resources/views/form/edit.blade.php ENDPATH**/ ?>