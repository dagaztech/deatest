                      ...
                      <div class="btns-vertical-wrapper"> 
                        <div class="row">
                            ...
                            <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="orange-btn">
                                <a href="<?php echo e(route('user-administrador.registro-usuarios')); ?>" alt="Registro de usuarios">Registro de usuarios</a>
                             </div>
                             ...
                             <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="purple-btn">
                              <a href="<?php echo e(route('user-administrador.carga-masiva')); ?>" alt="Carga Masiva de Registros">Carga Masiva de Registros</a>
                           </div>
                        </div>
                      </div>
                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/dea-template-pwa/resources/views/user-administrador/index.blade.php ENDPATH**/ ?>