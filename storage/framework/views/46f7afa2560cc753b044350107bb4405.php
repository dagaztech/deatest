<?php $__env->startSection('title', __('Registro de usuario operador')); ?>
        ...
        <div class="mx-auto col-md-12 rounded-card">
                <div class="card"  id="orange-btn">
                    ...
                    <div class="card-body form-card-body" id="orange-btn">
                        ...
                        <div class="row">
                            <iframe src="forms/survey/wX90Gz3YaOpbxqlW142B" scrolling="auto" style="height:100vh;" width="100%"></iframe>
                        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/dea-template-pwa/resources/views/user-administrador/creacion-usuario.blade.php ENDPATH**/ ?>