...
<?php $__env->startSection('title', __('Consulta de Registro de Equipos DEA')); ?>
                      ...
                      <div class="btns-vertical-wrapper"> 
                        <div class="row">
                            ...
                            <!--div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="purple-btn">
                             ...
                             <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="purple-btn">
                                <a href="<?php echo e(route('user-consultassm.informe-ubicaciondeas')); ?>" alt="Ubicación de Equipos DEA">Ubicación de Equipos DEA</a>
                             </div>
                        </div>
                      </div>
                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\dea-template-pwa-last\resources\views/user-consultassm/regequipos-dea.blade.php ENDPATH**/ ?>