<?php $__env->startSection('title', __('Agregar Formulario')); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10"><?php echo e(__('Agregar Formulario')); ?></h4>
        </div>
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><?php echo e(__('Agregar Formulario')); ?></li>
        </ul>
    </div>
    ...
    <div class="row">
        ...
        border-radius: 1em;">
            <a class="btn-addnew-project h-100 w-100" href="<?php echo e(route('forms.create')); ?>">
                ...
                <h6 class="mt-4 mb-2"><?php echo e(__('Agregar nuevo formulario')); ?></h6>
                <p class="text-center text-muted"><?php echo e(__('Haz clic aquí para crear formulario en blanco')); ?></p>
            </a>
        </div>
                ...
                <div class="text-center text-white card h-100 w-100">
                    <div class="pb-0 border-0 card-header">
                        <div class="d-flex align-items-center">
                            <?php if($formTemplate->status == 1): ?>
                                <span class="p-2 px-3 badge rounded-pill bg-success"><?php echo e(__('Activar')); ?></span>
                            <?php else: ?>
                                <span class="p-2 px-3 badge rounded-pill bg-danger"><?php echo e(__('Desactivar')); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <a href="<?php echo e(route('forms.use.template', $formTemplate->id)); ?>"
                            ...
                            role="button"><span><?php echo e(__('Usar Plantilla de Formulario')); ?></span></a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/dea-template-pwa/resources/views/form/add.blade.php ENDPATH**/ ?>