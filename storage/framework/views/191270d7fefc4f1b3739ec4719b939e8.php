...
<?php $__env->startSection('title', __('Diligenciamiento de Formularios')); ?>
...
<?php $__env->startPush('style'); ?>
    <link href="<?php echo e(secure_asset('vendor/jqueryform/css/jquery.rateyo.min.css')); ?>" rel="stylesheet" />
    <link rel="stylesheet" href="<?php echo e(secure_asset('vendor/formTheme/form.css')); ?>">
    <style>
...
<?php $__env->startPush('script'); ?>
     <script src="<?php echo e(secure_asset('vendor/jqueryform/js/jquery.rateyo.min.js')); ?>"></script>
                    ...
                    if (response.is_success) {
                        //if('<?php echo e($form->id); ?>' == 13){
                            //$('.form-card-body').html(
                                        ...
                                        //'</hr>'+
                                        //'<img src="<?php echo e(secure_asset('assets/images/success.gif')); ?>" class="" /><br><br><h2 class="w-100 ">' +
                                        //"Registro Exitoso" + '</h2></div>');
                        //}else{


                        $('.form-card-body').html(
                            '<div class="text-center gallery" id="success_loader"> <img src="<?php echo e(secure_asset('assets/images/success.gif')); ?>" class="" /><br><br><h2 class="w-100 ">' +
                        ...
                        show_toastr('Error!', response.message, 'danger',
                            '<?php echo e(secure_asset('assets/images/notification/high_priority-48.png')); ?>', 4000);
                        $('#nextBtn').removeAttr('disabled');
                        $('#nextBtn').html('Enviar')
                        showTab(0);
                    }
                            ...
                            success: function(data) {
                                ...
                                if (data.txnToken == "") {
                                    show_toastr('Failed!', data.message, 'danger',
                                        '<?php echo e(secure_asset('assets/images/notification/high_priority-48.png')); ?>',
                                        4000);
                        ...
                        var handler = PaystackPop.setup({
                            ...
                            callback: function(response) {
                                ...
                                show_toastr('Done!', 'Payment complete! Reference: ' + reference, 'success',
                                    '<?php echo e(secure_asset('assets/images/notification/ok-48.png')); ?>', 4000);
                                submitForm(formData);
                            },
                            onClose: function() {
...
<?php echo $__env->make('layouts.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/dea-template-pwa/resources/views/form/public-fill.blade.php ENDPATH**/ ?>