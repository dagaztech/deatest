        ...
        <div class="card" id="green-btn">
          ...
          <div class="card-body form-card-body">
            <div class="row">
              ...
              <h2>Ubicación del DEA</h2>
              <p>Haga clic sobre el DEA que desea ubicar en el mapa</p>
               <!--SE ALIMENTA DESDE FORMULARIO 33-->
              <table  class="ubicacion-tabla tablas-mapa">
                <thead>
                  <tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/dea-template-pwa/resources/views/user-consultassm/informe-ubicaciondeas.blade.php ENDPATH**/ ?>