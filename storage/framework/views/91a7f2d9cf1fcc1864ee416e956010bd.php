                        ...
                        <div class="menu-item-right-col d-flex align-items-center justify-content-between">
                            <!--div class="menu-left-col">
                                <ul class="main-nav d-flex align-items-center">
                                    <li><a href="{ { route('landingpage') }}" tabindex="0"><?php echo e(__('Home')); ?></a></li>
                                    <?php
...
<?php /**PATH C:\Users\andresmauriciogomezr\Documents\proyectos\dea-template-pwa\resources\views/layouts/app-header.blade.php ENDPATH**/ ?>