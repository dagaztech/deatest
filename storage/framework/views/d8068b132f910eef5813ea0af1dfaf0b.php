<?php $__env->startSection('title', __('Diseñar Formulario')); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10"><?php echo e(__('Diseñar Formulario')); ?></h4>
        </div>
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> <?php echo e(__('Diseñar Formulario')); ?> </li>
        </ul>
    </div>
        ...
        <div class="main-content">
            <?php if(isset($_SERVER['REQUEST_SCHEME']) && $_SERVER['REQUEST_SCHEME'] == 'http'): ?>
                <div class="alert alert-warning">
                    <b>
                        <?php echo e(__('Tenga en cuenta que las funciones de grabación de video y selfies solo están disponibles en sitios web HTTPS y no funcionan en sitios HTTP.')); ?></b>
                </div>
            <?php endif; ?>
                        ...
                        <div class="col-xl-12 order-xl-1">
                            <div class="card">
                                <div class="card-header">
                                    <h5><?php echo e(__('Diseñar Formulario')); ?></h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-12">
...
<?php if(\Auth::guard('api')->user()->rol = 'Operativo SSM'): ?>
<?php $__env->startPush('style'); ?>
<style>
.ui-sortable .number-field{
    pointer-events: none;
    opacity: 0.5;
    cursor:default;
}
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\dea-template-pwa-last\resources\views/form/design.blade.php ENDPATH**/ ?>