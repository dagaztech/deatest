...
<?php
    ...
    $type = '';
    if ($user) {
        //$roleId = DB::table('tbl_roles')->where('id', 1)->first();
        $roleId = 1;
        $type = 'public';
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php if(!isset($form_value) && $form->payment_status == 1): ?>
                                    ...
                                    <?php elseif(!isset($form_value) && $form->payment_type == 'paytm'): ?>
                                        <div class="paytm">
                                            <p><?php echo e(__('Make Payment')); ?></p>
                                    ...
                                    <?php elseif(!isset($form_value) && $form->payment_type == 'flutterwave'): ?>
                                    ...
                                    <?php elseif(!isset($form_value) && $form->payment_type == 'paystack'): ?>
                                        <div class="paystack">
                                            <p><?php echo e(__('Make Payment')); ?></p>
                                            <?php echo Form::hidden('payment_id', null, ['id' => 'payment_id']); ?>
                                    ...
                                    <?php elseif(!isset($form_value) && $form->payment_type == 'coingate'): ?>
                                        <div class="coingate">
                                            <p><?php echo e(__('Make Payment')); ?></p>
                                            <?php echo Form::hidden('payment_id', null, ['id' => 'payment_id']); ?>
                                    ...
                                    <?php elseif(!isset($form_value) && $form->payment_type == 'mercado'): ?>
                                        <div class="mercado">
                                            <p><?php echo e(__('Make Payment')); ?></p>
                                            <?php echo Form::hidden('payment_id', null, ['id' => 'payment_id']); ?>
                                    ...
                                    <?php elseif(!isset($form_value) && $form->payment_type == 'payumoney'): ?>
                                        <div class="payumoney">
                                            <p><?php echo e(__('Make Payment')); ?></p>
                                            <?php echo Form::hidden('payment_id', null, ['id' => 'payment_id']); ?>
                                    ...
                                    <?php elseif(!isset($form_value) && $form->payment_type == 'mollie'): ?>
                                        <div class="mollie">
                                            <p><?php echo e(__('Make Payment')); ?></p>
                                            <?php echo Form::hidden('payment_id', null, ['id' => 'payment_id']); ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <div class="m-auto form-group col-6">
                                <p><?php echo e(__('Use this link to share the poll with your participants.')); ?></p>
                                <div class="input-group">
                                    ...
                                    <a href="#" class="btn btn-primary js-copy" data-clipboard="true"
                                        data-clipboard-target="#pc-clipboard-1"> <?php echo e(__('Copy')); ?>
                                ...
                                <div class="mt-3 social-links-share">
                                    ...
                                    <a href="javascript:void(1);" class="social-links-share-main"
                                        title="Show QR Code" data-action="<?php echo e(route('forms.survey.qr', $id)); ?>"
                                        id="share-qr-image">
        ...
        <?php if($form->allow_comments == 1): ?>
            <div class="row">
                <div class="mx-auto col-xl-7 order-xl-1">
                    <div class="card">
                        <div class="card-header">
                            <h5> <i class="me-2" data-feather="message-circle"></i><?php echo e(__('Comments')); ?></h5>
                        </div>
                        <?php echo Form::open([
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <?php echo Form::text('name', null, ['class' => 'form-control', 'required', 'placeholder' => __('Enter your name')]); ?>
                        ...
                        <div class="card-footer">
                            <div class="text-end">
                                <?php echo Form::submit(__('Add a comment'), ['class' => 'btn btn-primary']); ?>
                                    ...
                                    <span class="text-left comment-info">
                                        ...
                                        <h6 class="d-block">
                                            ...
                                            <a href="#reply-comment"
                                                class="text-dark reply-comment-<?php echo e($value->id); ?>"
                                                id="comment-reply" data-bs-toggle="collapse"
                                                data-id="<?php echo e($value->id); ?>" title="<?php echo e(__('Reply')); ?>">
                                                <?php echo e(__('Reply')); ?></i></a>
                                            <?php if(Auth::guard('api')->user()): ?>
                                                <?php echo Form::open([
                                                    'method' => 'DELETE',
                                                ...
                                                <a href="#" class="text-dark show_confirm" title="Delete"
                                                    id="delete-form-<?php echo e($value->id); ?>"><?php echo e(__('Delete')); ?></a>
                                                <?php echo Form::close(); ?>
                                        ...
                                        <?php $__currentLoopData = $value->replyby; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reply_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="comment-replies">
                                                ...
                                                <div class="comment-replies-content">
                                                    ...
                                                    <span
                                                        class="d-block"><small><?php echo e($reply_value->reply); ?></small></span>
                                                    <h6 class="d-block">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\andresmauriciogomezr\Documents\proyectos\dea-template-pwa\resources\views/form/multi-form.blade.php ENDPATH**/ ?>