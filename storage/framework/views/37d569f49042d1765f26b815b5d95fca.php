                    ...
                    <div class="card-body form-card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="green-btn">
                               <a href="#" alt="Información de espacios o lugares">Información de espacios o lugares</a>
                            </div>
                            <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="green-btn">
                                <a href="#" alt="Información de usuarios">Información de usuarios</a>
                             </div>
                             <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="green-btn">
                                <a href="#" alt="Información de reporte de
instalación">Información de reporte de
instalación</a>
                             </div>
                             <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="green-btn">
                                <a href="#" alt="Información de reporte de uso">Información de reporte de uso</a>
                             </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\andresmauriciogomezr\Documents\proyectos\dea-template-pwa\resources\views/user-administrador/gestion-informacion.blade.php ENDPATH**/ ?>