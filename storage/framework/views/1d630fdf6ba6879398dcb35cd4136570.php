                ...
                <div class="col-xl-9">
                    ...
                    <div id="storage-setting" class="">
                        ...
                        <div class="card" id="settings-card">
                            ...
                            <div class="card-body">
                                <div class="pb-3">
                                    <p class="text-danger"><?php echo e(__('Note :- If you Add S3 & wasabi Storage settings then you have to store all images First.')); ?></p>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div id="recaptcha"
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <?php echo Form::text('recaptcha_key', Utility::getsettings('recaptcha_key'), [
                                                    'class' => 'form-control',
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php echo Form::text('recaptcha_secret', Utility::getsettings('recaptcha_secret'), [
                                                    'class' => 'form-control',
                        ...
                        <div class="justify-content-between card-header d-flex align-items-center">
                            ...
                            <div class="d-flex align-items-center text-end">
                                <div class="custom-control custom-switch" onclick="enableseo()">
                                    ...
                                    <small class="text-end d-flex mt-2"><?php echo e(__('Please turn on this SEO Enable button.')); ?></small>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div id="cache-setting" class="">
                        <div class="card" id="settings-card">
                            <div class="card-header">
                                ...
                                <small>
                                    <?php echo e(__('This is a page meant for more advanced users, simply ignore it if you don\'t
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\dea-template-pwa-last\resources\views/settings/index.blade.php ENDPATH**/ ?>