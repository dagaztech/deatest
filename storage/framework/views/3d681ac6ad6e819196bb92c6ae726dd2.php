...
<?php $__env->startSection('title', __('Usuarios')); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10"><?php echo e(__('Usuarios')); ?></h4>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><?php echo Html::link(route('home'), __('Panel de Control'), []); ?></li>
            <li class="breadcrumb-item active"><?php echo e(__('Usuarios')); ?></li>
        </ul>
        <div class="float-end">
            <div class="d-flex align-items-center">
                <a href="<?php echo e(route('grid.view','view')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Vista Grid')); ?>"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/dea-template-pwa/resources/views/users/index.blade.php ENDPATH**/ ?>