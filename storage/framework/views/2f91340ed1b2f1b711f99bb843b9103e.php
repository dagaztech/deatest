        ...
        <div class="mx-auto col-md-12 rounded-card">
                <div class="card">
                    <div class="card-header">
                        <h5 class="text-center w-100" id="new-title">Inicio</h5>
                    </div>
                      ...
                      <div class="btns-vertical-wrapper">
                        <div class="row">
                            ...
                            <div class="col-md-6 btn-navigate btn-primary btn-block mt-3" id="orange-btn">
                                <a href="<?php echo e(route('user-operador1.menu-anexo3')); ?>" alt="Anexo 3. Reporte del uso del Desfibrilador Externo Automático (DEA). Formulario Dinámico.">Anexo 3. Reporte del uso del Desfibrilador Externo Automático (DEA). Formulario Dinámico.</a>
                             </div>
                        </div>
                      </div>
                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\andresmauriciogomezr\Documents\proyectos\dea-template-pwa\resources\views/user-operador1/index.blade.php ENDPATH**/ ?>