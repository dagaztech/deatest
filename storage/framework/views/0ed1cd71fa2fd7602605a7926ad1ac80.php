...
<?php $__env->startSection('title', __('Campos del Evento- Uso')); ?>
        ...
        <div class="mx-auto col-md-12 rounded-card" >
                <div class="card" id="green-btn">
                    <div class="card-header">
                        <h5 class="text-center w-100" id="new-title">Campos del Evento - Uso</h5>
                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\andresmauriciogomezr\Documents\proyectos\dea-template-pwa\resources\views/user-administrador/formulario-campo-uso.blade.php ENDPATH**/ ?>