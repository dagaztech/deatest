<?php
    $user_theme = \Auth::guard('api')->user();
        ...
        <div class="col-12 d-flex">
            <div class="mb-4 row">
                <div class="mb-3 col-xxl-7">
                    <div class="row h-100">
                        <?php if(\Auth::guard('api')->user()->rol == "Administrador"): ?>
                                            ...
                                            <div class="text-center col-12">
                                                ...
                                                <div class="mt-3 text-center">
                                                    <?php
                                                        ...
                                                        $id = $hashids->encodeHex(Auth::guard('api')->user()->id);
                                                    ?>
                            ...
                            <div class="m-0 card comp-card">
                                <div class="card-body admin-wish-card">
                                    <div class="row h-100">
                                        ...
                                        <h4 class="f-w-400">
                                            <a href="<?php echo e(Storage::exists(Auth::guard('api')->user()->avatar) ? Storage::url(Auth::guard('api')->user()->avatar) : Auth::guard('api')->user()->avatar_image); ?>" target="_new">
                                                <img src="<?php echo e(Storage::exists(Auth::guard('api')->user()->avatar) ? Storage::url(Auth::guard('api')->user()->avatar) : Auth::guard('api')->user()->avatar_image); ?>"
                                                    class="me-2 img-thumbnail rounded-circle" width="50px"
                                                    height="50px"></a>
                                            <span class="text-muted"><?php echo e(Auth::guard('api')->user()->name); ?></span>
                                        </h4>
                                        <p>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\andresmauriciogomezr\Documents\proyectos\dea-template-pwa\resources\views/dashboard/home.blade.php ENDPATH**/ ?>