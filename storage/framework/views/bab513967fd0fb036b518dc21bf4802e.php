         ...
         <div class="login-row d-flex">
            <div class="login-content-inner ">
               ...
               <div class="mb-3 form-group">
                  <?php echo e(Form::label('email', __('Usuario'), ['class' => 'form-label mb-2'])); ?>
               ...
               <div class="mb-3 form-group">
                  <div class="col-md-12">
                     ...
                     <?php echo Html::link(route('password.request'), __('Recuperar contraseña ?'), ['class' => 'float-end forget-password']); ?>
               ...
               <?php endif; ?>
               <div class="d-grid">
                  <?php echo Form::button(__('Ingresar'), ['type' => 'submit', 'class' => 'btn btn-primary btn-block mt-3']); ?>
               ...
               <div class="register-option">
                  ...
                  <div class="create_user text-center ">
                     <?php echo e(__('¿No tiene cuenta?')); ?>

                     <a href="<?php echo e(route('register')); ?>"><?php echo e(__('Regístrese')); ?></a>
                  </div>
                  <?php endif; ?>
               </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\andresmauriciogomezr\Documents\proyectos\dea-template-pwa\resources\views/auth/login.blade.php ENDPATH**/ ?>