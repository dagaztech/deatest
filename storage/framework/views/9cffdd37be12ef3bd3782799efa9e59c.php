...
<?php $__env->startSection('title', __('Carga Masiva')); ?>
<link rel="stylesheet" href="<?php echo e(asset('vendor/fileupload/css/jquery.fileupload.css')); ?>">
<script>
  ...
  <div class="mx-0 mt-5 row">
    <div class="mx-auto col-md-12 rounded-card">
        ...
        <div class="card-body form-card-body">
          ...
          <ul class="note-list">
            ...
            <li> Si desea puede verificar el formato correcto de sus archivos aquí:
              <ul>
                <li> <a href="../../docs/Registro Acta Visita.xlsx" target="_blank">Registro Acta Visita</a></li>
                <li> <a href="../../docs/Registro Plan Mejora.xlsx" target="_blank">Registro Plan Mejora</a></li>
                ...
                <li> <a href="../../docs/Registro operador entidad.xlsx" target="_blank">Registro operador entidad</a></li>
                <li> <a href="../../docs/Registro operador SSM.xlsx" target="_blank">Registro operador SSM</a></li>
                <li> <a href="../../docs/Registro Representante Legal.xlsx" target="_blank">Registro Representante Legal</a></li>
          ...
          <div class="form-group">
            <select name="formulario" class="form-control" id="formularioss">
              <option value="9">Registro operador entidad</option>
              <option value="39">Registro operador SSM</option>
              <option value="7">Registro Espacios</option>
              <option value="31">Registro Representante Legal</option>
              <option value="33">Registro DEA</option>
              <option value="18">Registro Acta Visita</option>
              <option value="19">Registro Plan Mejora</option>
            </select>
          </div>
      ...
      <div class="text-danger">
        <h4><?php echo html_entity_decode($error); ?></h4>
      </div>
      <?php endif; ?>
      <?php if(isset($resultado)): ?>
      <div class="text-success">
        <h4><?php echo html_entity_decode($resultado); ?></h4>
      </div>
      <?php endif; ?>
        </div>
...
<script src="<?php echo e(asset('vendor/fileupload/js/vendor/jquery.ui.widget.js')); ?>"></script>
<script src="<?php echo e(asset('vendor/fileupload/js/jquery.fileupload.js')); ?>"></script>
<script src="<?php echo e(asset('vendor/fileupload/js/jquery.fileupload-process.js')); ?>"></script>
<script src="<?php echo e(asset('vendor/fileupload/js/jquery.fileupload-validate.js')); ?>"></script>
<script src="<?php echo e(asset('vendor/fileupload/js/jquery.iframe-transport.js')); ?>"></script>
<script>
  $(function() {
        'use strict';
        var url = "",
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/dea-template-pwa/resources/views/user-administrador/carga-masiva.blade.php ENDPATH**/ ?>