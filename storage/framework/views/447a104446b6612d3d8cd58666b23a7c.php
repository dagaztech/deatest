...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <!--div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10">{ { __('Formularios registrados de ' . ' ' . $formsDetails->title) }}</h4>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item">{ !! Html::link(route('home'), __('Panel de control'), []) !!}</li>
            <li class="breadcrumb-item active"> { { __('Formularios registrados de ' . ' ' . $formsDetails->title) }} </li>
        </ul>
    </div-->
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\dea-template-pwa-last\resources\views/form-value/view-submited-form.blade.php ENDPATH**/ ?>