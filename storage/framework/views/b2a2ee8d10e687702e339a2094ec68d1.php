...
<?php $__env->startSection('title', __('Recuperar Contraseña')); ?>
         ...
         <div class="login-row d-flex">
                <div class="login-content-inner">
                    <div class="login-title">
                        <h3><?php echo e(__('Recuperar contraseña')); ?></h3>
                    </div>
                    <?php echo Form::open([
                    ...
                    <div class="text-center d-flex justify-content-center align-items-center">
                        <?php echo e(Form::button(__('Enviar enlace para restablecer contraseña'), ['type' => 'submit', 'class' => 'btn btn-primary'])); ?>

                        <a href="<?php echo e(route('home')); ?>" class="ml-2 text-white btn btn-secondary"><?php echo e(__('Regresar')); ?></a>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/dea-template-pwa/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>