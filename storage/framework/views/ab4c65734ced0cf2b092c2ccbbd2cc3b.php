...
<?php $__env->startSection('breadcrumb'); ?>
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10"><?php echo e(__('Perfil de Usuario')); ?></h4>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><?php echo Html::link(route('home'), __('Panel de Control'), []); ?></li>
            <li class="breadcrumb-item"> <?php echo e(__('Perfil de Usuario')); ?> </li>
        </ul>
    </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-block d-sm-flex align-items-center justify-content-between w-100">
                                    <div class="mb-3 mb-sm-0">
                                        ...
                                        <?php if(\Auth::guard('api')->user()->social_type != null): ?>
                            ...
                            <div class="mt-3 row container-fluid">
                                ...
                                <div class="col-sm-6" style="display:none;">
                                    <div class="form-group" >
                                        ...
                                        <?php echo Form::select('country', $countries, $user->country="Colombia", [
                                            'data-trigger',
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/dea-template-pwa/resources/views/profile/index.blade.php ENDPATH**/ ?>