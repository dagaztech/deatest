...
<meta name="meta_image_logo" property="og:image"
    ...
    <!-- font css -->
    <link rel="stylesheet" href="<?php echo e(secure_asset('assets/fonts/tabler-icons.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(secure_asset('assets/fonts/feather.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(secure_asset('assets/fonts/fontawesome.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(secure_asset('assets/fonts/material.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(secure_asset('vendor/css/bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(secure_asset('assets/css/plugins/bootstrap-switch-button.min.css')); ?>">

    <!-- Bootstrap datetimepicker css -->
    <!-- vendor css -->
    <link rel="stylesheet" href="<?php echo e(secure_asset('assets/css/plugins/flatpickr.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(secure_asset('assets/css/customizer.css')); ?>">

    <?php if($user->rtl_layout == 1 || $currantLang == 'ar'): ?>
        <link rel="stylesheet" href="<?php echo e(secure_asset('assets/css/style-rtl.css')); ?>" id="main-style-link">
    <?php endif; ?>
    <?php if($user->dark_layout == 1): ?>
        <link rel="stylesheet" href="<?php echo e(secure_asset('assets/css/style-dark.css')); ?>" id="main-style-link">
    <?php elseif($user->rtl_layout == 0): ?>
        <link rel="stylesheet" href="<?php echo e(secure_asset('assets/css/style.css')); ?>" id="main-style-link">
    <?php endif; ?>

    <link rel="stylesheet" href="<?php echo e(secure_asset('vendor/css/custom.css')); ?>">
...
<div class="loading">Cargando…</div>
    ...
    <script src="<?php echo e(secure_asset('assets/js/dash.js')); ?>"></script>
    ...
    <script src="<?php echo e(secure_asset('assets/js/plugins/bootstrap-notify.min.js')); ?>"></script>
...
<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
    ...
    <script src="<?php echo e(secure_asset('vendor/js/custom.js')); ?>"></script>
                    ...
                    success: function(response) {
                        if (response.mode == 1) {
                            ...
                            document.querySelector("#main-style-link").setAttribute("href",
                                "<?php echo e(secure_asset('assets/css/style-dark.css')); ?>"
                            );
                        } else {
                            ...
                            document.querySelector("#main-style-link").setAttribute("href",
                                "<?php echo e(secure_asset('assets/css/style.css')); ?>"
                            );
                        }
                    }
                });
...
<?php /**PATH /home/ubuntu/dea-template-pwa/resources/views/layouts/main.blade.php ENDPATH**/ ?>